...
from farm.config import SQL_DATABASE_MYCODO
...
INPUT_INFORMATION = {
    ...
    'message': """Requires: Farm >= 7.7.0. This Input was designed for use with the Moteino Mega with a LoRaWAN transceiver connected to a MightyOwn Geiger Counter (v1.0). Radiation measurements (CPM and μSv/hr) are transmitted to The Things Network (TTN). Farm uses this Input to download the measurements from TTN and transmit them to Safecast and GMC Map. More info at https://github.com/mir-one/Farm-custom/tree/master/custom_inputs/geiger%20counter""",
