# coding=utf-8
#
# farm_custom_output_remote_gpio_on_off.py - On/Off Remote GPIO Output
#
...
OUTPUT_INFORMATION = {
    ...
    'message':
        ...
        '<br>This output was developed to be able to operate from Farm installed on a Raspberry Pi '
        'or from Farm running within a docker container on a PC and control GPIO pins of a remote host, '
        ...
        'dependencies manually, then restart the Farm daemon, before using the output. '
